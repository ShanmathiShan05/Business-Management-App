...
public class AdminController {
	...
	public String seachHandler(@RequestParam("productName") String name,Model model)
	{
		...
		Products product=this.productServices.getProductByName(name);
		if(product==null)
		{
	...
	public String returnBack(Model model)
	{
		...
		List<Products>products=this.productServices.getAllProducts();
	...
	{
		Products product=this.productServices.getProduct(id);
